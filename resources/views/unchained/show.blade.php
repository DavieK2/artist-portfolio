<x-layouts.app>
    ...
    <div class="flex flex-col py-36 mx-auto px-7 lg:px-14  max-w-5xl">
        <div class="flex flex-col space-y-8 md:space-y-0  md:flex-row items-center md:space-x-24">
            <div class="flex">
                <img class="w-full h-full" src=" {{ asset("images/unchained/$work->image.png") }} ">
            </div>
            <div class="max-w-md">
                <div class="space-y-1">
        ...
        <div class="mt-16 w-full flex justify-end">
            <div class="mt-16 w-full flex justify-end">
                <a href="{{ url('/unchained') }}" class="flex flex-row space-x-2 text-gray-500 text-base font-medium">
